...
var st,nt;class rt extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{var s,n;const r=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:e;let o=r._$litPart$;if(void 0===o){const t=null!==(n=null==i?void 0:i.renderBefore)&&void 0!==n?n:null;r._$litPart$=o=new F(e.insertBefore(x(),t),t,void 0,null!=i?i:{})}return o._$AI(t),o})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!1)}render(){return I}}rt.finalized=!0,rt._$litElement$=!0,null===(st=globalThis.litElementHydrateSupport)||void 0===st||st.call(globalThis,{LitElement:rt});const ot=globalThis.litElementPolyfillSupport;null==ot||ot({LitElement:rt});(null!==(nt=globalThis.litElementVersions)&&void 0!==nt?nt:globalThis.litElementVersions=[]).push("3.3.3");class lt extends rt{static properties={_paramsMaxDepth:{state:!0},_paramsPostId:{state:!0},_paramsLimit:{state:!0},_urlBase:{state:!0},_urlOrigin:{state:!0},_hideDepth:{state:!0}};static styles=r`
  ...
  `;constructor(){super(),this._paramsMaxDepth=12,this._paramsPostId="1307075",this._paramsLimit=32,this._urlBase="/api/v3",this._urlOrigin="https://discuss.tchncs.de",this._hideDepth=4}_replaceLbsContainer(){const t=document.querySelector("lbs-container");t.insertAdjacentHTML("afterend",`<lbs-container\n        params-max-depth="${this._paramsMaxDepth}"\n        params-post-id="${this._paramsPostId}"\n        params-limit="${this._paramsLimit}"\n        url-base="${this._urlBase}"\n        url-origin="${this._urlOrigin}"\n        hide-depth="${this._hideDepth}"\n      ></lbs-container>`),t.remove()}render(){return B`
      <div>
        <label for="_paramsMaxDepth">params.max_depth</label>
        <input
          name="_paramsMaxDepth"
          @input=${t=>this._paramsMaxDepth=t.target.value}
      ...
      <div>
        ...
        <input
          name="_paramsPostId"
          @input=${t=>this._paramsPostId=t.target.value}
      ...
      <div>
        ...
        <input
          name="_paramsLimit"
          @input=${t=>this._paramsLimit=t.target.value}
